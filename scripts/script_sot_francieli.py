...
df_produto_credito = glueContext.create_dynamic_frame.from_catalog(
    ...
    table_name="produto_credito_sor_francieli"
).toDF()
...
# Escreve os dados na tabela db_sor_banco_xis.produto_credito_sot via insertInto
df_filtrado.write.insertInto("db_sot_banco_xis.produto_credito_sot_francieli", overwrite=True)


# URL do S3 = s3://landing-zone-850202893763-prod/credit_card_transactions_data.csv
# Consulta ATHENA = SELECT * FROM "db_sor_banco_xis"."produto_credito_spec_francieli"