...
df_sot = glueContext.create_dynamic_frame.from_catalog(
    ...
    table_name="produto_credito_sot_francieli"
).toDF()
...
# df_final.write.insertInto("db_spec_banco_xis.produto_credito_spec_francieli", overwrite=True)

# Escreve os dados na tabela db_spec_banco_xis.produto_credito_spec via insertInto
df_final.write.insertInto("db_spec_banco_xis.produto_credito_spec_francieli", overwrite=True)

# consulta athena = SELECT * FROM "db_spec_banco_xis"."produto_credito_spec_francieli"