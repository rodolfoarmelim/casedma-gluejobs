...
s3_path = "s3://landing-zone-850202893763-prod/credit_card_transactions_data.csv"
...
df_sor = spark.read.csv(s3_path, schema=schema, header=True)
...
df_sor.write.insertInto("db_sor_banco_xis.produto_credito_sor_andres", overwrite=True)