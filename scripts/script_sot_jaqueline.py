...
df_filtrado.write.insertInto("db_sot_banco_xis.produto_credito_sot_jaqueline", overwrite=True)

#df_filtrado.write.option("compression","snappy").partitionBy("anomes").saveAsTable(
  #  "db_sot_banco_xis.produto_credito_sot_jaqueline",
  #  format = "parquet",
  #  mode = "overwrite",
  #  path = "s3://corp-sot-sa-east-1-850202893763/produto_credito_sot_jaqueline/")