...
# Configurar modo de sobrescrita de partição
...
df_sot = glueContext.create_dynamic_frame.from_catalog(
    ...
    table_name="produto_credito_sot_byanca"
).toDF()
...
# Salvar tabela final
df_final.write.insertInto("db_spec_banco_xis.produto_credito_spec_byanca", overwrite=True)