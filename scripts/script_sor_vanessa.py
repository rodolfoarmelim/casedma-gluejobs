...
# Escreve os dados na tabela db_sor_banco_xis.produto_credito_sor_vanessa via insertInto
df_sor.write.insertInto("db_sor_banco_xis.produto_credito_sor_vanessa", overwrite=True)