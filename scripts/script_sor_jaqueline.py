...
df_sor.write.insertInto("db_sor_banco_xis.produto_credito_sor_jaqueline", overwrite=True)

#df_sor.write.option("compression","snappy").partitionBy("anomes").saveAsTable(
 #   "db_sor_banco_xis.produto_credito_sor",
   # format = "parquet",
   # mode = "overwrite",
   # path = "s3://corp-sor-sa-east-1-850202893763/produto_credito_sor_jaqueline/")